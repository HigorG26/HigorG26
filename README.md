...
CRAG_WEB	Web interface for an AI application	TypeScript · Angular
taskManager	Task CRUD with add, edit and delete	React · TypeScript · Tailwind
API-Express-TS	Back-end API for React integration	Node.js · Express · TypeScript
Python_DataAnalysis	Automation of a manual date-validation task	Python · Jupyter
---
<div align="center">
